  ...
  <FullWidthContainer variant="footer" pos="relative">
    ...
    >
      <HStack spacing={4} pb={[`2rem`, 0]}>
        <a
          href="https://github.com/lp-mkdir"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/luis-eduardo-pacheco/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Icon
      ...
      <VStack alignItems="flex-start">
        ...
        <Button
          ...
          href="mailto:contact@lpmkdir.com"
        >
          EMAIL
        </Button>
      </VStack>
    ...
    >
      <div>
        &copy; {new Date().getFullYear()} by Luis Pacheco. All rights reserved.
      </div>
