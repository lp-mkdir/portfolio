    ...
    <Center>
      ...
      >
        ...
        <Box
          px={4}
          py={8}
          bgGradient="linear(to-tr, primary.800, primary.900)"
          boxShadow="xl"
        >
          <Flex
          ...
          >
            <Text
              ...
              pr={[0, null, 8]}
            >
              This site uses cookies for functional and personal analytical
              purposes. Please, feel free to accept or delete them.
            </Text>
